...
public class WFCControl : MonoBehaviour {
    ...
    void Update() {
        ...
        else if (Input.GetKeyDown(KeyCode.P)) ToggleVideo();
    }
    ...
    void ToggleVideo() {
        ...
        if (debugging) Debug.Log("[WFC Control] Toggled play/pause on " + videoPlayer.gameObject.name);

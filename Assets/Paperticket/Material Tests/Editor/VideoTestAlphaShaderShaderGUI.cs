...
namespace UnityEditor {
    internal class VideoTestAlphaShaderShaderGUI : ShaderGUI {
        ...
        public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] props) {
           ...
           //     m_ShowLatLongLayout.valueChanged.AddListener(materialEditor.Repaint);
            ...
            ShowProp(materialEditor, FindProperty("_TransparentColor", props));
            ShowProp(materialEditor, FindProperty("_Threshold", props));
